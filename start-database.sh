...
DB_CONTAINER_NAME="grader-kutech-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=grader-kutech -d -p 5432:5432 docker.io/postgres
